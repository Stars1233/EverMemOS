...
def format_documents_for_llm(
    ...
    Args:
        ...
        use_episode: True=use Episode Memory, False=use Atomic Fact
    ...
    for i, (doc, score) in enumerate(results[:max_docs], start=1):
        ...
        if use_episode:
            ...
            # Fall back to episode if no atomic fact data
            episode = doc.get("episode", "N/A")
            if len(episode) > 500:
                episode = episode[:500] + "..."
